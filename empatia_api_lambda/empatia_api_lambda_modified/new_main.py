...
def lambda_handler(event, context):
    ...
    # Bound the body size before parsing to limit DoS exposure
    ...
    tenant_attr = _safe_tenant_id(payload.get("tenant_id"))
    ...
    try:
        sqs_response = sqs.send_message(
            ...
            MessageAttributes={
                ...
                "tenant_id": {"StringValue": tenant_attr, "DataType": "String"},
            },
        )
